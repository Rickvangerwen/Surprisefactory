...
<body onload="surprisefactory.hint()">
	...
	<div id="goed" class="melding-kader">
		...
		<div class="content-midden">
			...
			<p id="antwoord-goed2" class="antwoord-kop" style="color: green;">GEFELICITEERD</p>
			<p class="antwoord-subkop">JIJ HEBT DE BOX ONTRAFELD, BEKIJK SNEL WAT JE GAAT DOEN.</p>
			<p class="antwoord-knop" style="background-color: green; border-bottom: 2px solid #006600;" onclick="surprisefactory.link()">BEKIJK JE CADEAU</p>
